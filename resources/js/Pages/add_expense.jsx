...
export default function add_expense({ auth, addexpense }) {
  // Form data
  ...
  const submitForm = async () => {
    try {
      ...
      // Use fetch or Axios to send a POST request to the Laravel backend
                          ...
                          <div class="flex">
                              <div class="flex-1">
                                <div class="form-group row">
                                    ...
                                    <div class="sm:w-1/2">
                                      <input type="text" name="expenseAmount" id="expenseAmount" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="$ 0.00"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="sm:w-1/2">
                                        <input type="date" name="expenseDate" id="expenseDate" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                        value={expenseDate} onChange={(e) => setExpenseDate(e.target.value)} required />
                                    </div>
                                  </div>
                              </div>
                              <div class="flex-1">
                              <label for="expenseCategory" class=" col-form-label"><b>kjh</b></label>
                                <div>
                                <select class="z-2 absolute mt-1 sm:w-1/4 rounded bg-gray-50 ring-1 ring-gray-300" name="expenseCategory" id="expenseCategory"
                                  value={expenseCategory} onChange={(e) => setExpenseCategory(e.target.value)} required >
